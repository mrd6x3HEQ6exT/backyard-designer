...
- Yard outline, patio, lawn, pavers, rock, planter wall, mulch beds — as polygons, rectangles, circles, or curves: every corner is an anchor you can flip between straight and smooth, with draggable tangent handles
...
Test: `npm ci && npm test` — a browserless build-integrity/syntax check plus a 110-assertion Playwright
