...
- Yard outline, patio, lawn, pavers, rock, planter wall, mulch beds — as polygons, rectangles, circles, or curves: draw square, then round any corner to a radius by dragging or typing it; or flip a corner to smooth for a free curve with tangent handles
...
Test: `npm ci && npm test` — a browserless build-integrity/syntax check plus a 122-assertion Playwright
