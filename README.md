...
- Yard outline, patio, lawn, pavers, rock, planter wall, mulch beds — as polygons, rectangles, circles, or curves: draw square like a house outline, then bend any edge into an arc by dragging its middle (or typing a radius), round any corner, or flip an anchor to smooth for a free curve
...
Test: `npm ci && npm test` — a browserless build-integrity/syntax check plus a 136-assertion Playwright
